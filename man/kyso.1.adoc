...
Valid _subcommands_ and their _arguments_ are:
  ...
  *add* _<comma_separated_list_of_orgs>_:::
    Add the organizations in the _comma_separated_list_of_orgs_ to the system.
    This command asks interactively for the minimum data required to create
    them and later the user can update the information using the frontend or
    the `get` and `set` subcommands.

  *del* _<comma_separated_list_of_orgs>_:::
    Remove the organizations included in the _comma_separated_list_of_orgs_.

  *download* *photo* _<organization>_ _<image_file>_:::
    Download the `photo` images of the given _organization_
    and save them on the provided _image_file_.

  *upload* *photo* _<organization>_ _<image_file>_:::
  ...
  *get* [ _--images_ ] [ _--no-channels_ ] _<list_of_orgs>_ _<yaml_file>_:::
    ...
    channels) of the organizations in the _comma_separated_list_of_orgs_ on a
    _yaml_file_.
+
...
Valid _subcommands_ and their _arguments_ are:
  ...
  *add* _<organization>_ _<comma_separated_list_of_channels>_:::
    Add the channels on the _comma_separated_list_of_channels_ to the given
    _organization_. This command asks interactively for the minimum data
    required to create each organization and later the user can update the
    information using the frontend or the `get` and `set` subcommands.

  *del* _<organization>_ _<comma_separated_list_of_channels>_:::
    Remove the channels on the _comma_separated_list_of_channels_ from the
    given _organization_.

  *get* _<organization>_ _<comma_separated_list_of_channels>_ _<yaml_file>_:::
    Save the configuration values of the channels on the
    _comma_separated_list_of_channels_ from the given _organization_ on a
    _yaml_file_.
...
*user* _subcommand_ _<arguments>_::
  ...
  *add* _<comma_separated_list_of_users>_:::
    Add the users on the _comma_separated_list_of_users_ to the system; the
    command asks interactively for the required parameters and later an admin
    can update values using the `get` and `set` subcommands.

  *del* _<comma_separated_list_of_users>_:::
    Remove the users on the _comma_separated_list_of_users_ from the system.
  ...
  *get* [ _--images_ ] _<comma_separated_list_of_users>_ _<yaml_file>_:::
    Save the configuration values of the users in the
    _comma_separated_list_of_users_ on a _yaml_file_.
+
If the `--images` flag is passed the _<yaml_file>_ will contain copies of the
background and photo images encoded in `base64`.
